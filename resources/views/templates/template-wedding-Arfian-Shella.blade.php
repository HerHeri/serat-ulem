...
<head>
  ...
  <title>{{ $du->nama_pengantin_pria }} & {{ $du->nama_pengantin_wanita }} | Undangan Pernikahan</title>
  <link rel="stylesheet" href="{{ url('/') }}/assets-4/css/aos.css" />
  <link rel="stylesheet" href="{{ url('/') }}/assets-4/css/bootstrap.min.css" />
  <link rel="stylesheet" href="{{ url('/') }}/assets-4/css/style.css" />
  <link rel="stylesheet" href="{{ url('/') }}/assets-4/css/owl.carousel.min.css" />
  <link rel="stylesheet" href="{{ url('/') }}/assets-4/css/owl.theme.default.min.css" />
...
<body>
  <!-- lagu start -->
  <audio loop id="lagu">
    <source src="{{ url('/') }}/Dudy Oris - Laksana Surgaku.mp3" type="audio/mp3" />
  </audio>
  <!-- lagu end -->
  <!-- popup start -->
  <div class="d-none">
  ...
  <div class="modal fade" id="exampleModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
      <div class="modal-content">
        <div class="modal-body bg-wakwak p-0" style="padding: 0 !important;">
          <div class="row justify-content-center mt-0 text-center h-100" id="front-image-container">
            <div class="col-md-6 col-12" id="front-image">
              <img src="{{ url('/') }}/img-arfian/CAM1-10.JPG" alt=""/>
            </div>
            <div class="flex col-md-6 col-12 mt-auto mb-auto" id="front-text">
              <p><small>The Wedding of</small></p>
              <h1 class="font-dancing fs-60">{{ $du->nama_pengantin_wanita }} <br/>&<br /> {{ $du->nama_pengantin_pria }}</h1>
              {{-- <small class="mt-3">{{ date_format(new \DateTime($du->tanggal_resepsi), 'l, j F Y') }}</small> --}}
              <small class="mt-3">{{ \Carbon\Carbon::parse($du->tanggal_resepsi)->isoFormat('dddd, Do MMMM YYYY')}}</small>
              <hr class="border-secondary w-50 mx-auto" />
              <p class="mb-1">Kepada Bapak/Ibu/Saudara/i</p>
              <p class="mb-2 mt-2"><span class="fw-semibold h4" id="namatamu">{{ $nama_undangan }}</span></p>
              <p class="mb-2">di Tempat</p>
              <button type="button" class="btn bg-berem btn-outline-secondary text-dark rounded-4"
  ...
  <header class="bg-wakwak" >
    <div class="d-flex justify-content-center align-items-center vh-100" id="header-img" style="background-image: url({{ url('/') }}/img-arfian/CAM1-11.JPG); background-size: cover; opacity: 0.9;">
      <div class="container">
        <div class="row text-center">
          <div class="col-12 mt-5">
            The Wedding of
            <h1 class="font-dancing fs-60">{{ $du->nama_pengantin_wanita }} <br/>&<br /> {{ $du->nama_pengantin_pria }}</h1>
            <p>{{ \Carbon\Carbon::parse($du->tanggal_resepsi)->isoFormat('dddd, Do MMMM YYYY')}}</p>
          </div>
          <div class="col-12">
              ...
              <div class="col-md-8">
                <div class="row mb-3">
                  <div class="col-3 m-0 p-1">
                    <div class="card p-2 my-auto rounded-4 bg-berem text-dark">
  ...
  <!-- ayat end -->
  <svg id="wave" class="bg-berem" style="transform: rotate(0deg); transition: 0.3s" viewBox="0 0 1440 160"
    ...
    <div class="container py-5">
      <div class="row text-center justify-content-center">
        <div class="col-12 mb-5" data-aos="zoom-in" data-aos-duration="1300">
          <img src="{{ url('/') }}/assets-4/img/bismillah.png" alt="" width="200px" class="mb-3" />
        ...
        <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1100">
          <img src="{{ url('/') }}/img-arfian/CAM1-6.JPG" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
          <h1 class="font-dancing text-dark fs-45">{{ $du->nama_pengantin_wanita }}</h1>
          <p class="m-0 p-0">{{ $du->anak_keberapa_wanita }}</p>
          <p class="m-0 p-0">Bapak {{ $du->ayah_pengantin_wanita }} & Ibu {{ $du->ibu_pengantin_wanita }}</p>
        </div>
        ...
        <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
          <img src="{{ url('/') }}/img-arfian/CAM1-7.JPG" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
          <h1 class="font-dancing text-dark fs-45">{{ $du->nama_pengantin_pria }}</h1>
          <p class="m-0 p-0">{{ $du->anak_keberapa_pria }}</p>
          <p class="m-0 p-0">Bapak {{ $du->ayah_pengantin_pria }} & Ibu {{ $du->ibu_pengantin_pria }}</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <svg id="wave" class="bg-wakwak" style="transform: rotate(0deg); transition: 0.3s" viewBox="0 0 1440 210"
    ...
    <defs>
      <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
        <stop stop-color="rgba(199, 200, 204, 0.84)" offset="0%"></stop>
        <stop stop-color="rgba(199, 200, 204, 1)" offset="100%"></stop>
      </linearGradient>
    </defs>
    ...
    <defs>
      <linearGradient id="sw-gradient-1" x1="0" x2="0" y1="1" y2="0">
        <stop stop-color="rgba(199, 200, 204, 0.74)" offset="0%"></stop>
        <stop stop-color="rgba(199, 200, 204, 1)" offset="100%"></stop>
      </linearGradient>
    </defs>
    ...
    <defs>
      <linearGradient id="sw-gradient-2" x1="0" x2="0" y1="1" y2="0">
        <stop stop-color="rgba(199, 200, 204, 0.8)" offset="0%"></stop>
        <stop stop-color="rgba(199, 200, 204, 1)" offset="100%"></stop>
      </linearGradient>
    </defs>
  ...
  <section class="bg-berem" id="date">
    <div class="container py-5">
      <div class="row text-center justify-content-center">
        <div class="col-12 mb-5" data-aos="zoom-in" data-aos-duration="1300">
          <h1 class="font-dancing fs-40 text-dark">Save The Date</h1>
        </div>
        <div class="col-md-6 col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="750">
          <div class="card p-3 shadow bg-fee">
            <h1 class="font-dancing mb-3 fs-40">Akah Nikah & Resepsi</h1>
            <p class="fw-bold p-0 m-0">{{ \Carbon\Carbon::parse($du->tanggal_resepsi)->isoFormat('dddd, Do MMMM YYYY')}}</p>
            <p class="m-0 p-0">Pukul {{ $du->jam_resepsi }}</p>
            <p class="m-0 p-0">{{ $du->lokasi_resepsi }}<br>{{ $du->alamat_resepsi }}</p>
            <center>
              <a href="https://maps.app.goo.gl/FoCmTQTLcRLUJuvq7?g_st=iw" target="_blank" style="width: 175px;" class="text-decoration-none btn btn-light btn-outline-secondary mb-3 mt-3 rounded-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div class="col-md-6 col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
          <div class="card p-3 shadow bg-fee">
            <h1 class="font-dancing mb-3 fs-40">Unduh Mantu</h1>
            <p class="fw-bold p-0 m-0">{{ \Carbon\Carbon::parse($du->tanggal_unduh_mantu)->isoFormat('dddd, Do MMMM YYYY')}}</p>
            <p class="m-0 p-0">Pukul {{ $du->jam_unduh_mantu }}</p>
            <p class="m-0 p-0">{{ $du->lokasi_unduh_mantu }}<br>{{ $du->alamat_unduh_mantu }}</p>
            <center>
              <a href="https://maps.app.goo.gl/EqBjKF3hiaePXwWx9?g_st=iw" target="_blank" style="width: 175px;" class="text-decoration-none btn btn-light btn-outline-secondary mb-3 mt-3 rounded-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                  class="bi bi-geo-alt-fill mb-1" viewBox="0 0 16 16">
                  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                </svg>Buka Google Map
        ...
        {{-- <div class="col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
          <h1 class="font-dancing mb-3 fs-40 text-dark">Lokasi</h1>
          <p class="text-dark">
            {{ $du->lokasi_resepsi }}, {{ $du->alamat_resepsi }}
          </p>
          <a href="https://maps.app.goo.gl/FoCmTQTLcRLUJuvq7?g_st=iw" target="_blank"
          ...
          <div class="col-12">
            <div class="row mb-5 justify-content-center" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500" data-aos-offset="0">
              ...
              <div class="col-md-5 col-10">
                <div class="card bg-berem rounded-3 text-dark p-3 text-start shadow">
      ...
      <div class="row text-center text-dark">
        ...
        <div class="col-12" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="800">
          <div class="owl-carousel owl-theme">
            {{-- @for ($i = 1; $i == 18; $i++)
              <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-{{ $i }}.JPG"/></div>
            @endfor --}}
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-3.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-4.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-5.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-8.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-9.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-13.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-14.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-15.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-16.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-17.JPG" /></div>
            <div class="item"><img src="{{ url('/') }}/img-arfian/CAM1-18.JPG" /></div>
          </div>
        </div>
        <div class="col-12 mt-5" data-aos="zoom-in" data-aos-duration="1300">
          <h1 class="font-dancing fs-40">Our Moments</h1>
        </div>
        <div class="col-12" data-aos="zoom-in" data-aos-diration="1300">
          <video width="340" height="195" controls style="border-radius: 10px; object-fit: initial;" 
            poster="{{ url('/') }}/img-arfian/CAM1-11.JPG">
            <source src="{{ url('/') }}/img-arfian/Full Arfian Shela.mp4" type="video/mp4">
          </video>
        </div>
      </div>
    </div>
  ...
  <section class="bg-wakwak">
    <div class="container py-5">
      <div class="row text-center justify-content-center">
        <div class="col-12 mb-5" data-aos="zoom-in" data-aos-duration="1300">
          <div class="card bg-berem shadow text-dark mb-2 w-75 p-2 mx-auto">
        ...
        <div class="col-md-6 mb-3 blur" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
          <div class="card bg-fee rounded-3 shadow p-3">
            <img src="{{ url('/') }}/assets-4/img/mandiri-logo.png" height="50px" alt="" class="mx-auto" />
            <hr />
            <p><span><input type="text" value="{{ $du->no_rek_digital_1 }}" class="bg-fee norek" id="rek1" readonly /></span> a/n {{ $du->nama_rek_digital_1 }}</p>
            <div>
              <button class="btn bg-berem text-dark btn-outline-secondary rounded-pill" onclick="copyRekening('{{ $du->no_rek_digital_1 }}')">
                <div class="mx-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <div class="card bg-fee rounded-3 shadow p-3 mt-3">
            <img src="{{ url('/') }}/assets-4/img/Bank_Central_Asia.svg" height="50px" alt="" class="mx-auto" />
            <hr />
            <p><span><input type="text" value="{{ $du->no_rek_digital_2 }}" class="bg-fee norek" id="rek2" readonly /></span> a/n {{ $du->nama_rek_digital_2 }}</p>
            <div>
              <button class="btn bg-berem text-dark btn-outline-secondary rounded-pill" onclick="copyRekening('{{ $du->no_rek_digital_2 }}')">
                <div class="mx-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-clipboard2-check-fill mb-1" viewBox="0 0 16 16">
                    <path
      ...
      <div class="row text-center justify-content-center">
        ...
        <div class="col-lg-8 col-md-10 col-12">
          <div class="row justify-content-center" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="2000">
            <div class="col-4">
              <img src="{{ url('/') }}/assets-4/img/cuci-tangan-2.png" class="scale" width="100px" alt="" />
              <p class="text-sm">Cuci Tangan</p>
            </div>
            <div class="col-4">
              <img src="{{ url('/') }}/assets-4/img/pakai-masker.png" class="scale" width="100px" alt="" />
              <p class="text-sm">Gunakan Masker</p>
            </div>
            <div class="col-4">
              <img src="{{ url('/') }}/assets-4/img/jaga-jarak-2.png" class="scale" width="100px" alt="" />
  ...
  <section class="bg-wakwak">
    <div class="container py-5">
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-10 col-12 mx-2 mb-5" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="2500">
          <div class="card bg-fee rounded-3 p-3">
            <form action="javascript:void(0)" id="formUndangan" method="post">
              @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
                <textarea name="ucapan" id="ucapan" placeholder="Pesan" rows="4" class="form-control" required></textarea>
              ...
              <div class="mb-3 text-start">
                <button type="button" id="btn-submit" class="btn bg-berem btn-outline-secondary text-dark">Kirim</button>
              </div>
            </form>
      ...
      <div class="row text-center justify-content-center">
        <div class="col-lg-9 col-md-11 col-12">
          <div data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
            <img src="{{ url('/') }}/img-arfian/CAM1-15.JPG" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
          ...
          <div data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1250">
            <h1 class="font-dancing fs-60">{{ $du->nama_pengantin_wanita }}</h1>
            <h1 class="font-dancing fs-60">&</h1>
            <h1 class="font-dancing fs-60">{{ $du->nama_pengantin_pria }}</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="bg-kulit">
    <div class="container pb-5">
      <div class="row text-center">
        <div class="col-12">
          <small class="p-0 m-0">
            Developed by <a target="_blank" href="http://imheri.my.id" target="_blank">Made Heri</a>
          </small>
        </div>
      </div>
    </div>
  ...
  <div class="text-end fixed-bottom me-3 mb-3">
    <div class="btn-group">
      <button type="button" class="btn btn-sm bg-berem btn-outline-secondary" onclick="stopAudio()">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          class="bi bi-stop-fill text-dark" viewBox="0 0 16 16">
          <path
  ...
  <!-- button audio -->
  <script src="{{ url('/') }}/assets-4/js/jquery.min.js"></script>
  <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  <script src="{{ url('/') }}/assets-4/js/owl.carousel.min.js"></script>
  <script src="{{ url('/') }}/assets-4/js/main.js"></script>
  <script src="{{ url('/') }}/assets-4/js/bootstrap.bundle.min.js"></script>
  <script src="{{ url('/') }}/assets-4/js/aos.js"></script>
