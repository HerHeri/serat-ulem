...
<body>
  <!-- lagu start -->
  <audio loop id="lagu">
    <source src="{{ url('/') }}/assets-4/audio/audio.mp3" type="audio/mp3" />
  </audio>
  <!-- lagu end -->
  <!-- popup start -->
  <div class="d-none">
        ...
        <div class="modal-body bg-wakwak p-0">
          <div class="row justify-content-center mt-0 text-center h-100" id="front-image-container">
            <div class="col-md-6 col-12" id="front-image">
              <img src="{{ url('/') }}/assets-4/img/img3.jpg" alt=""/>
            </div>
  ...
  <header class="bg-wakwak">
    <div class="d-flex justify-content-center align-items-center vh-100"
      style="background-image: url({{ url('/') }}/assets-4/img/img7.png); background-size: cover">
      <div class="container">
    ...
    <div class="container py-5">
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1100">
          <img src="{{ url('/') }}/assets-4/img/img9.jpg" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
        ...
        <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
          <img src="{{ url('/') }}/assets-4/img/img8.jpg" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
      ...
      <div class="row text-center text-white">
        ...
        <div class="col-12" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="800">
          <div class="owl-carousel owl-theme">
            <div class="item"><img src="{{ url('/') }}/assets-4/img/img2.jpg" /></div>
            <div class="item"><img src="{{ url('/') }}/assets-4/img/img3.jpg" /></div>
            <div class="item"><img src="{{ url('/') }}/assets-4/img/img4.jpg" /></div>
            <div class="item"><img src="{{ url('/') }}/assets-4/img/img5.jpg" /></div>
            <div class="item"><img src="{{ url('/') }}/assets-4/img/img6.jpg" /></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-6 mb-3 blur" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
          <div class="card bg-fee rounded-3 shadow p-3">
            <img src="{{ url('/') }}/assets-4/img/bni.png" height="50px" alt="" class="mx-auto" />
            <hr />
      ...
      <div class="row text-center justify-content-center">
        <div class="col-lg-9 col-md-11 col-12">
          <div data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
            <img src="{{ url('/') }}/assets-4/img/img10.jpg" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
  ...
  <footer class="bg-kulit">
    <div class="container pb-5">
      <div class="row text-center">
        <div class="col-12">
          <small class="p-0 m-0">
            Original Design by <a target="_blank" href="https://github.com/aldiui">ImHeri</a> | 2024
          </small>
        </div>
      </div>
    </div>
