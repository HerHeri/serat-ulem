...
<html lang="en">
  <head>
    ...
    <title>WEDDING DIAN & RAHMAT</title>
    <link
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;600;700&family=Ephesis&display=swap"
      rel="stylesheet"
    />
  ...
  <body>
    ...
    >
      ...
      >
        ...
        <a href="#home" class="btn btn-lg mt-5" onClick="enablescroll()"
          >Lihat Undangan</a
        >
      </main>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-8 text-center mt-5">
            <h5 class="fw-bold" data-aos="fade-right" data-aos-duration="2000">
              Bismillahirrahmanirrahim
            </h5>
            <p data-aos="fade-right" data-aos-duration="2000">
              Maha Suci Allah yang telah menciptakan makhluk-Nya
              berpasang-pasangan. Ya Allah, perkenankanlah kami merangkaikan
              kasih sayang yang Kau ciptakan di antara kami untuk mengikuti
              Sunnah Rasul-Mu dalam rangka membangun keluarga yang sakinah,
              mawaddah, warahmah.
            </p>
            <p data-aos="fade-left" data-aos-duration="2000">
              Maka dengan segenap kerendahan hati , kami mengundang
              Bapak/Ibu/Saudara untuk dapat hadir dan berbagi kebahagiaan dalam
              acara penikahan kami:
            </p>
          </div>
        </div>
        ...
        <div class="container text-center mempelai">
          <div class="row mb-5">
            <div class="col-12" data-aos="fade-right" data-aos-duration="2000">
              <h1>Dian Purnama Sari, S.Pd</h1>
              <p>
                Putri Dari <br />Bapak H. M. Ali Asmin <br />& Ibu Hj. Jannatun,
                S.Pd
              </p>
            </div>
            <div
            ...
            <div class="col-12" data-aos="fade-left" data-aos-duration="2000">
              <h1>Rahmat</h1>
              <p>Putra Dari <br />Alm Bapak Muchtar Lutfi<br />& Ibu Rohani</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-8 col-10 text-center">
            ...
            <p class="alamat" data-aos="fade-left" data-aos-duration="2000">
              Alamat: Jl. Tanjung Pura, Gg. Umar, Pelawi Utara, Kec. Babalan,
              Kabupaten Langkat, Sumatera Utara 20857
            </p>
            <iframe
        ...
        >
          ...
          >
            <a href="{{ url('/') }}/assets-1/img/mempelai/1.jpg" data-lightbox="gallery">
              <img
                src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/1.jpg"
                alt="Ami Reza 1"
          ...
          >
            <a href="{{ url('/') }}/assets-1/img/mempelai/2.jpg" data-lightbox="gallery">
              <img
                src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/2.jpg"
                alt="Ami Reza 2"
                class="img-fluid w-100 rounded"
                data-lightbox="gallery"
              />
          ...
          >
            <a href="{{ url('/') }}/assets-1/img/mempelai/3.jpg" data-lightbox="gallery">
              <img
                src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/3.jpg"
                alt="Ami Reza 3"
                class="img-fluid w-100 rounded"
                data-lightbox="gallery"
              />
          ...
          >
            <a href="{{ url('/') }}/assets-1/img/mempelai/4.jpg" data-lightbox="gallery">
              <img
                src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/4.jpg"
                alt="Ami Reza 4"
                class="img-fluid w-100 rounded"
              />
            </a>
          ...
          >
            <a href="{{ url('/') }}/assets-1/img/mempelai/5.jpg" data-lightbox="gallery">
              <img
                src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/5.jpg"
                alt="Ami Reza 5"
                class="img-fluid w-100 rounded"
              />
            </a>
          ...
          >
            <a href="{{ url('/') }}/assets-1/img/mempelai/6.jpg" data-lightbox="gallery">
              <img
                src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/6.jpg"
                alt="Ami Reza 6"
                class="img-fluid w-100 rounded"
              />
            </a>
          ...
          >
            <a href="{{ url('/') }}/assets-1/img/mempelai/9.jpg" data-lightbox="gallery">
              <img
                src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/9.jpg"
                alt="Ami Reza 9"
                class="img-fluid w-100 rounded"
              />
            </a>
          ...
          >
            <a href="{{ url('/') }}/assets-1/img/mempelai/10.jpg" data-lightbox="gallery">
              <img
                src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/10.jpg"
                alt="Ami Reza 10"
                class="img-fluid w-100 rounded"
              />
            </a>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-8 col-10 text-center">
            ...
            <img
              src="{{ url('/') }}/assets-1/img/mandiri.png"
              data-aos="zoom-in"
              data-aos-duration="2000"
            />
            <div
      ...
      <div class="container">
        <div class="row">
          <div class="col text-center">
            ...
            <small class="block"
              >Design by
              <a href="https://instagram.com/afrihmzh">@afrihmzh</a>.</small
            >
          </div>
        </div>
      </div>
