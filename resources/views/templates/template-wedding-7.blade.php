...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="{{ url('/') }}/assets-1/style.css" />
    <!-- Lightbox CSS -->
    <link rel="stylesheet" href="{{ url('/') }}/assets-1/lightbox2/dist/css/lightbox.min.css" />
    <style>
      @font-face{
        font-family: "Sunroll";
        src: url("{{ url('/') }}/assets-6/asset/Sunroll.ttf");
      }

      @font-face{
        font-family: "Eyesome Script";
        src: url("{{ url('/') }}/assets-1/fonts/Eyesome Script.otf");
      }
  ...
  <body>
    <section id="hero" class="hero w-100 h-100 p-3 mx-auto text-center d-flex justify-content-center align-items-center text-white" style="width: 414px !important;" >
      <div class="frame">
        <img
          src="{{ url('/') }}/assets-1/img/frame-tl.png"
          alt=""
        ...
        />
        <img
          src="{{ url('/') }}/assets-1/img/frame-tr.png"
          alt=""
        ...
        />
        <img
          src="{{ url('/') }}/assets-1/img/frame-bl.png"
          alt=""
        ...
        />
        <img
          src="{{ url('/') }}/assets-1/img/frame-br.png"
          alt=""
      ...
      >
        ...
        <div class="elmnt-image">
          {{-- <img src="{{ url('/') }}/assets-6/asset/img/ah.png" title="Septi Samsul" alt="Septi Samsul" data-recalc-dims="1" style="width: 200px;" /> --}}
        ...
        <div class="simply-countdown mt-5">Nama Tamu</div>
        <a href="#home" class="btn btn-lg mt-2" style="position: relative; top: 50px;" onClick="enablescroll()">Lihat Undangan</a>
      </main>
    </section>

    {{-- <nav class="navbar navbar-expand-md bg-body-tertiary sticky-top mynavbar" style="width: 414px !important;">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-11 text-center mt-0">
            ...
            <div class="mb-4 mx-auto d-flex flex-column justify-content-center animate__animated animate__zoomIn animate__slower image-editable" style="width: 80%; overflow: hidden; aspect-ratio: 1 / 1; background-image: url('/assets-1/img/frame-emp.webp'); background-size: 100%;">
              <div class="mx-auto image-editable" style="width: 180px; height: 180px;">
                <img src="{{ url('/assets-1/img/pasangan.webp') }}" alt="Pasangan" class="w-100 h-100">
              </div>
            </div>
          ...
          <div class="row mb-2">
            ...
            <div class="col-12" data-aos="fade-right" data-aos-duration="2000">
              <div class="animate__animated animate__zoomIn animate__slower" style="position: relative;">
                <div style="position: absolute; width: 100%; left: 0px; right: 0px; bottom: -19px; height: 74px; background-image: url('/assets-1/img/photo-frame.webp'); background-size: contain; background-position: center center; background-repeat: no-repeat;"></div>
    ...
    <section class="gallery" id="gallery" style="width: 414px !important;">
        <div class="frame">
            <img src="{{ url('/') }}/assets-1/img/frame-tl.png" alt=""
        ...
        <div class="container">
            ...
            <div class="row row-cols-lg-12 row-cols-md-3 row-cols-sm-2 row-cols-2 justify-content-center">
                <div class="col mt-4" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-1/img/mempelai/1.jpg" data-lightbox="gallery">
                        <img src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/1.jpg"
                ...
                <div class="col mt-4" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-1/img/mempelai/2.jpg" data-lightbox="gallery">
                        <img src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/2.jpg"
                            alt="Ami Reza 2" class="img-fluid w-100 rounded" data-lightbox="gallery" />
                    </a>
                </div>
                <div class="col mt-4" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-1/img/mempelai/3.jpg" data-lightbox="gallery">
                        <img src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/3.jpg"
                            alt="Ami Reza 3" class="img-fluid w-100 rounded" data-lightbox="gallery" />
                    </a>
                </div>
                <div class="col mt-4" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-1/img/mempelai/4.jpg" data-lightbox="gallery">
                        <img src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/4.jpg"
                            alt="Ami Reza 4" class="img-fluid w-100 rounded" />
                    </a>
                </div>
                <div class="col mt-4" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-1/img/mempelai/5.jpg" data-lightbox="gallery">
                        <img src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/5.jpg"
                            alt="Ami Reza 5" class="img-fluid w-100 rounded" />
                    </a>
                </div>
                <div class="col mt-4" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-1/img/mempelai/6.jpg" data-lightbox="gallery">
                        <img src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/6.jpg"
                            alt="Ami Reza 6" class="img-fluid w-100 rounded" />
                    </a>
                </div>
                <div class="col mt-4" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-1/img/mempelai/9.jpg" data-lightbox="gallery">
                        <img src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/9.jpg"
                            alt="Ami Reza 9" class="img-fluid w-100 rounded" />
                    </a>
                </div>
                <div class="col mt-4" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-1/img/mempelai/10.jpg" data-lightbox="gallery">
                        <img src="{{ url('/') }}/assets-1/img/mempelai/thumbnail/10.jpg"
          ...
          <div class="col-10 text-center">
            ...
            <div class="card text-center text-bg-light mb-5 p-2">
              <div class="card-header fw-bold" style="background: none;">
                <img src="{{ url('/') }}/assets-4/img/mandiri-logo.png" data-aos="zoom-in" data-aos-duration="2000" style="margin: 0;" />
              </div>
              <div class="card-body">
            ...
            <div class="card text-center text-bg-light mb-5 p-2">
              <div class="card-header fw-bold" style="background: none;">
                <img src="{{ url('/') }}/assets-4/img/Bank_Central_Asia.svg" data-aos="zoom-in" data-aos-duration="2000" style="margin: 0;" />
              </div>
              <div class="card-body">
                <div class="fw-bolds" data-aos="zoom-in-up" data-aos-duration="2000" >
                  <p id="myInput">1090018086470</p>
    ...
    {{-- <div id="audio-container">
      <audio id="song" autoplay loop>
        <source
          src="{{ url('/') }}/assets-1/Audio/Afgan ft. Rossa - Kamu Yang Kutunggu (Lirik).mp3"
          type="audio/mp3"
        />
      </audio>
    ...
    <!-- Lightbox JS -->
    <script src="{{ url('/') }}/assets-1/lightbox2/dist/js/lightbox.min.js"></script>
    <!-- Custom js -->
    <script src="{{ url('/') }}/assets-1/script.js"></script>
