...
<head>
    ...
    <!-- App -->
    <link rel="stylesheet" href="{{ url('/') }}/assets-5/css/app.css">
    <script src="{{ url('/') }}/assets-5/js/app.js" type="module" defer></script>
</head>
...
<body data-key="bfb9cfea33ab7ae21a315fbd6f065a815d3e20ff2f007aa2ca" data-url="https://api.ulems.my.id/" style="overflow-y: hidden;">
            ...
            <div class="text-center pt-4">
                ...
                <div class="py-4">
                    <div class="img-crop border border-3 border-light shadow mx-auto">
                        <img src="{{ url('/') }}/assets-5/assets/images/bg.jpeg" alt="bg" onclick="util.modal(this)">
                    </div>
                </div>
                ...
                <div class="overflow-x-hidden">
                    ...
                    <div data-aos="fade-right" data-aos-duration="2000">
                        <div class="img-crop border border-3 border-light shadow my-4 mx-auto">
                            <img src="{{ url('/') }}/assets-5/assets/images/cowo.png" alt="cowo" onclick="util.modal(this)">
                        </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        <div class="img-crop border border-3 border-light shadow my-4 mx-auto">
                            <img src="{{ url('/') }}/assets-5/assets/images/cewe.png" alt="cewe" onclick="util.modal(this)">
                        </div>
        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            <div class="text-center">
                ...
                <div class="img-crop border border-3 border-light shadow mb-4 mx-auto">
                    <img src="{{ url('/') }}/assets-5/assets/images/bg.jpeg" alt="background">
                </div>
    ...
    <!-- Audio Button -->
    <button type="button" id="button-music" style="display: none;" class="btn bg-dark border border-2 btn-sm rounded-circle btn-music" onclick="audio.button(this)" data-status="true" data-url="{{ url('/') }}/assets-5/assets/music/sound.mp3">
    ...
    <div class="loading-page bg-black" id="loading" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            <div class="w-75 text-center">
                <img class="img-fluid mb-3" src="{{ url('/') }}/assets-5/assets/images/icon-192x192.png" alt="icon" style="width: 3.5rem;">
            ...
            <div class="modal-content rounded-4">
                <div class="modal-body p-0">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="{{ url('/') }}/assets-5/assets/images/bg.jpeg" class="w-100" alt="image" id="show-modal-image">
                    </div>
                </div>
            </div>
        </div>
