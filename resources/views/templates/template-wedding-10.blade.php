...
<html lang="en">
  ...
  <body>
    ...
    <section class="gallery" id="gallery" style="width: 414px !important;">
        <div class="frame">
            <img src="{{ url('/') }}/assets-lp/img-template/temp2/tl.webp" alt=""
