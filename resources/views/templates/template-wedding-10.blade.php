...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="{{ url('/') }}/assets-lp/style-template-5.css" />
    <!-- Lightbox CSS -->
  ...
  <body>
    <section id="hero"
        ...
        style="width: 414px !important;">
        <div class="frame">
            <img src="{{ url('/') }}/assets-lp/img-template/temp5/frame-tl.webp" alt=""
                class="position-absolute top-0 start-0" data-aos="zoom-out" data-aos-duration="2000"
                data-aos-easing="ease-in-out" style="width: 150px;" />
            <img src="{{ url('/') }}/assets-lp/img-template/temp5/frame-tr.webp" alt=""
                class="position-absolute top-0 end-0" data-aos="zoom-out" data-aos-duration="2000"
                data-aos-easing="ease-in-out" style="width: 150px;" />
            <img src="{{ url('/') }}/assets-lp/img-template/temp5/frame-bl.webp" alt=""
                class="position-absolute bottom-0 start-0" data-aos="zoom-out" data-aos-duration="2000"
                data-aos-easing="ease-in-out" style="width: 150px;" />
            <img src="{{ url('/') }}/assets-lp/img-template/temp5/frame-br.webp" alt=""
                class="position-absolute bottom-0 end-0" data-aos="zoom-out" data-aos-duration="2000"
                data-aos-easing="ease-in-out" style="width: 150px;" />
        </div>
        <main data-aos="zoom-in" data-aos-duration="2000" data-aos-easing="ease-in-out">
            <!-- <h5 style="position: relative; top: -14px; font-size: 28px;" class="eyesome-script">The Wedding Of</h5> -->
            <div class="elmnt-image">
                <img src="{{ url('/') }}/assets-lp/img-template/temp4/gunungan.webp" title="Wedding"
                    alt="Wedding" data-recalc-dims="1" style="width: 150px;" />
          ...
          <span style="transform: translate(-10px, 10px);">R</span> -->
            ...
            <a href="javascript:void(0)" class="btn btn-lg mt-2" style="position: relative; top: 50px;"
                onClick="enablescroll()">Lihat Undangan</a>
        </main>
    </section>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-11 text-center mt-0">
                    <h5 class="eyesome-script" style="font-size: 30px;" data-aos="fade-right" data-aos-duration="2000">
                        Save The Date</h5>
                    <div class="mb-4 mx-auto d-flex flex-column justify-content-center animate__animated animate__zoomIn animate__slower image-editable"
                        ...
                        <div class="mx-auto image-editable"
                            ...
                            <img src="{{ url('/') }}/assets-lp/img-template/pasangan.webp"
                                alt="Pasangan" class="w-100 h-100"
                                style="width: 200px !important; height: 200px !important;">
                        </div>

                        <!-- Frame mempelai -->
                        <div class="frame-mempelai" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-image: url('/assets-lp/img-template/temp4/frame-mempelai.png');
                            background-size: 100%; background-repeat: no-repeat; z-index: 2;">
                        </div>
                    </div>
                    <h5 class="eyesome-script" style="font-size: 30px;" data-aos="fade-right" data-aos-duration="2000">
                        Dian & Rahmat</h5>
                    <h2 data-aos="fade-left" data-aos-duration="2000" style="color: white;">03 Januari 2024</h2>
                    <p data-aos="fade-right" data-aos-duration="2000"
                        style="font-size: medium; margin: 0 0 10px 0; color: white;">
                    ...
                    <p data-aos="fade-left" data-aos-duration="2000" style="font-size: medium; color: white;">
                        (QS. Ar-Ruum 30 : 21)
                    </p>
                </div>
            </div>
            ...
            <div class="container text-center mempelai">
                <div class="row mb-2">
                    <div class="col-12" data-aos="fade-right" data-aos-duration="2000">
                        <p style="font-size: medium; line-height: 19px; margin: 0; position: relative; color: white;">
                    ...
                    <div class="col-12" data-aos="fade-right" data-aos-duration="2000">
                        <div class="animate__animated animate__zoomIn animate__slower" style="position: relative;">
                            <div
                                style="position: absolute; width: 100%; left: 0px; right: 0px; bottom: -19px; height: 74px; background-image: url('/assets-lp/img-template/photo-frame.webp'); background-size: contain; background-position: center center; background-repeat: no-repeat;">
                            </div>
                            <div class="image-editable"
                                style="height: 120px; width: 120px; margin: auto auto 20px; border-radius: 100%; overflow: hidden;">
                                <img src="https://assets.satumomen.com/assets/pengantin-wanita-ilustrasi-1688039849.jpg"
                                    alt="pengantin-wanita-ilustrasi-1688039849.jpg"
                                    style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                        <h2 style="font-size: 2.5rem">Dian Purnama Sari</h2>
                        <p style="font-size: medium; line-height: 19px; color: white;">Putri Dari <br />Bapak H. M. Ali
                            Asmin <br />& Ibu Hj. Jannatun, S.Pd</p>
                    </div>
                    ...
                    <div class="col-12" data-aos="fade-left" data-aos-duration="2000">
                        <div class="animate__animated animate__zoomIn animate__slower" style="position: relative;">
                            ...
                            <div class="image-editable"
                                style="height: 120px; width: 120px; margin: auto auto 20px; border-radius: 100%; overflow: hidden;">
                                <img src="https://assets.satumomen.com/assets/pengantin-pria-ilustrasi-1688039880.jpg"
                                    alt="pengantin-pria-ilustrasi-1688039880.jpg"
                                    style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                        <h2 style="font-size: 2.5rem">Rahmat</h2>
                        <p style="font-size: medium; line-height: 19px; color: white;">Putra Dari <br />Alm Bapak
                            Muchtar Lutfi<br />& Ibu Rohani</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-10 text-center">
                    <h2 style="font-size: 28px; font-weight: 200;" data-aos="fade-left" data-aos-duration="2000">
                        Assalamu'alaikum Warahmatullahi Wabarakatuh</h2>
                    <p class="alamat" data-aos="fade-left" data-aos-duration="2000"
                        style="font-size: medium; line-height: 19px; color: white;">
                        Dengan memohon rahmat dan ridho Allah SWT, kami mengharap kehadiran Bapak / Ibu / Saudara / i
        ...
        <div class="container">
            ...
            <div class="row row-cols-lg-12 row-cols-md-3 row-cols-sm-2 row-cols-2 justify-content-center">
                <div class="col mt-4" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-lp/img-template/mempelai/1.jpg"
                ...
                <div class="col mt-4" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-lp/img-template/mempelai/2.jpg"
                        data-lightbox="gallery">
                ...
                <div class="col mt-4" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-lp/img-template/mempelai/3.jpg"
                        data-lightbox="gallery">
                ...
                <div class="col mt-4" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-lp/img-template/mempelai/4.jpg"
                        data-lightbox="gallery">
                ...
                <div class="col mt-4" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-lp/img-template/mempelai/5.jpg"
                        data-lightbox="gallery">
                ...
                <div class="col mt-4" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-lp/img-template/mempelai/6.jpg"
                        data-lightbox="gallery">
                ...
                <div class="col mt-4" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-lp/img-template/mempelai/9.jpg"
                        data-lightbox="gallery">
                ...
                <div class="col mt-4" data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-duration="2000">
                    <a href="{{ url('/') }}/assets-lp/img-template/mempelai/10.jpg"
                        data-lightbox="gallery">
    ...
    <section id="lokasi" class="gallery" style="width: 414px !important;">
        <div class="frame">
            <img src="{{ url('/') }}/assets-lp/img-template/temp5/frame-tl.webp" alt=""
                class="position-absolute top-0 start-0" data-aos="zoom-out" data-aos-duration="2000"
                data-aos-easing="ease-in-out" style="width: 150px;" />
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-10 text-center">
                    <h2 data-aos="zoom-in-down" data-aos-duration="2000" style="font-size: 38px; font-weight: 200;">
                    ...
                    <iframe
                        ...
                        data-aos-duration="2000"></iframe>
                    <p class="mt-5" data-aos="zoom-in-down" data-aos-duration="2000"
                        style="font-size: medium; line-height: 19px; color: white;">
                    ...
                    <a href="https://maps.app.goo.gl/JGLV2bpX6moHwkPp6" target="_blank"
                        class="btn btn-light btn-sm my-3 mt-5 mb-5" data-aos="zoom-in" data-aos-duration="2000">Klik
    ...
    <section id="gifts" class="gallery" style="width: 414px !important;">
        <div class="frame">
            <img src="{{ url('/') }}/assets-lp/img-template/temp5/frame-tl.webp" alt=""
                class="position-absolute top-0 start-0" data-aos="zoom-out" data-aos-duration="2000"
                data-aos-easing="ease-in-out" style="width: 150px;" />
                ...
                <div class="col-10 text-center">
                    ...
                    <div class="card text-center text-bg-light mb-5 p-2">
                        <div class="card-header fw-bold" style="background: none;">
                            <img src="{{ url('/') }}/assets-lp/img-bank/mandiri-logo.png"
                                data-aos="zoom-in" data-aos-duration="2000" style="margin: 0;" />
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card text-center text-bg-light mb-5 p-2">
                        <div class="card-header fw-bold" style="background: none;">
                            <img src="{{ url('/') }}/assets-lp/img-bank/Bank_Central_Asia.svg"
                                data-aos="zoom-in" data-aos-duration="2000" style="margin: 0;" />
                        </div>
                        <div class="card-body">
                            <div class="fw-bolds" data-aos="zoom-in-up" data-aos-duration="2000">
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <small class="block">&copy; 2023 Dian & Rahmat Wedding. All Right Reserved.</small>
