        ...
        <div class="content-body">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Template</h4>
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <form id="creditTemplateForm" class="row gy-1 pt-75" >
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="nama_template" name="nama_template" class="form-control" placeholder="Masukkan Nama Template" />
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label" for="template">Status</label>
    ...
    var tableUndangan = $('#data-table-template').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return `<div class="d-flex flex-column">
                        <h6 class="mb-0">${row.nama_template ?? '-'}</h6>
                    </div>`
                }
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return `<div class="d-flex flex-column align-items-center">                        
                        <h6 class="mb-0  msg-template">${row.message}</h6>
                    </div>`
                }
            },
            {
