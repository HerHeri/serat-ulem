...
<head>
    ...
    <title>Template Wedding Invitation</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/app-assets/css/pages/page-misc.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper">
                    <a class="brand-logo" href="index.html">
                        ...
                        <h2 class="brand-text text-primary ms-1">Serat Ulem</h2>
                    </a>
                    <div class="misc-inner p-2 p-sm-3" style="max-width: 70% !important;">
                                ...
                                <div class="col-12">
                                    <div class="card text-center faq-contact-card shadow-none py-1">
                                        <div class="accordion-body">
                                            <a href="http://wa.me/6285746762431?text=Saya ingin bertanya mengenai undangan digital di Serat Ulem" target="_blank" rel="noopener noreferrer">
                                            ...
                                            <h4>Hubungi Kami</h4>
                                            <span class="text-body">Klik tombol phone di atas untuk menghubungi kami!</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2024<a class="ms-25" href="https://imheri.my.id" target="_blank">Made Heri</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span class="float-md-end d-none d-md-block">Hand-crafted & Made with<i data-feather="heart"></i></span></p>
    </footer>
