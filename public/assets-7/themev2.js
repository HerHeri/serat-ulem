(() => {
    ...
    playMusic = function (e) {
        f && (e ? (f.play(), w = !0) : (w ? f.pause() : f.play(), w = !w)), h && SC.Widget.Events.READY && (w ? (h.pause(), w = !1) : (h.play(), w = !0)), v && (w ? v.classList.add("playing") : v.classList.remove("playing"))
    ...
    var se = function () {
        ...
        ve = !1,
        fe = function () {
            ve = !0, autoPlay = setInterval((function () {
                se()
            }), 1e4), pe.classList.add("playing")
        },
        ge = function () {
            ve && (ve = !1, clearInterval(autoPlay), pe.classList.remove("playing"))
        };
